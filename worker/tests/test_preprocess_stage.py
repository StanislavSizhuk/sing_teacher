...
def test_preprocess_resamples_and_normalizes_recording(tmp_path: Path, wav_writer) -> None:
...
def test_prep_reference_resamples_and_normalizes(tmp_path: Path, wav_writer) -> None:
